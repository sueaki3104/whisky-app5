        ...
        <div class="max-w-7xl mx-auto sm:w-8/12 md:w-1/2 lg:w-5/12">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="mb-6" action="{{ route('shelves.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- 購入日 -->
                    <div class="mt-4">
                        <x-input-label for="buy_date" :value="__('購入日（必須）')" />
                    ...
                    <!-- 購入場所 -->
                    <div class="mt-4">
                        <x-input-label for="buy_address" :value="__('購入場所（必須）')" />
                    ...
                    <!-- ウイスキー名 -->
                    <div class="mt-4">
                        <x-input-label for="name" :value="__('ウイスキーの名前（必須）')" />
                    ...
                    <!-- 単価 -->
                    <div class="mt-4">
                        <x-input-label for="price" :value="__('単価(税込)（必須）')" />
                    ...
                    <!-- 購入数量 -->
                    <div class="mt-4">
                        <x-input-label for="num" :value="__('購入数量(半角数字のみ)（必須）')" />
                    ...
                    <div class="flex flex-col mt-4">
                        <x-input-label for="memory" :value="__('思い出（テキスト191文字）（必須）')" />
                        <textarea class="border py-2 px-3 text-grey-darkest resize-none" name="memory" id="memory" rows="4"></textarea>
                    </div>

                    <!-- 写真 -->
                    <div class="flex flex-col mt-4">
                        <x-input-label for="photo" :value="__('画像MAX1枚（ない場合は、当サイトのロゴが入ります）')" />
