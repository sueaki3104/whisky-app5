                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    当サイトはWhiskyが好きな私（福岡のウィスキー野郎@saisais40525414）が、Twitterをやっていて感じた「もっと自分に近い情報が欲しい」を叶えるために作ったものです。使い方はTwitterとほぼ同じですが特徴的なのは、所属する都道府県を選択するところにあります。あと、棚を実装していますのでボトルを登録できます。自分だけのコレクションを作ってください。
                                </div>
                            </div>
                        </div>
<!-- 都道府県について -->
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    常に投稿には所属する都道府県（左上）と投稿した時の都道府県（右下）が表示されます。また検索は３種類（ユーザーが所属する都道府県検索・投稿した都道府県検索・文字検索）ありますので、お近くの情報を探すときに役立つと思います。引っ越しや旅先での情報発信で都道府県を変えたい場合はプロフィールから変更可能です。
                                </div>
                            </div>
                        </div>
<!-- ログイン -->
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('login') }}" class="underline text-gray-900 dark:text-white">ログインへ</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    このサイトを既に利用されている方はこちらからログインしてください。このサイトはお酒に関する投稿や情報共有を目的に設置しておりますので20歳未満の方のご利用はお断りさせていただきます。
                                </div>
                            </div>
                        </div>
<!-- 新規登録 -->
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('register') }}" class="underline text-gray-900 dark:text-white">新規登録へ</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    このサイトを初めて利用されている方はこちらから新規登録をしてください。このサイトはお酒に関する投稿や情報共有を目的に設置しておりますので20歳未満の方のご利用はお断りさせていただきます。
                                </div>
                            </div>
                        </div>
                    </div>
