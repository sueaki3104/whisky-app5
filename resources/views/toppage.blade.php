                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    当サイトはWhiskyが好きな私が、Twitterをやっていて感じた「もっと自分に近い情報が欲しい」を叶えるために作ったものです。使い方はTwitterとほぼ同じですが特徴的なのは、所属する都道府県を選択するところにあります。
                                </div>
                            </div>
                        </div>
<!-- 都道府県について -->
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    常に投稿には所属する都道府県が表示されます。また検索は文字検索と都道府県検索がありますので、お近くの情報を探すときに役立つと思います。なおお引っ越しや旅先での情報発信で都道府県を変えたい場合はプロフィールから変更可能です。
                                </div>
                            </div>
                        </div>
<!-- ログイン -->
